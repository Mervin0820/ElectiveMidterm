...
from brighten import apply_clahe, load_images, save_image, show_resized

@pytest.fixture
def sample_image_path():
    # Path to the image in your repository
    return os.path.join("input", "brighten.png")

def test_apply_clahe_real_image(sample_image_path):
    # Load image
    img = cv2.imread(sample_image_path)
    assert img is not None, "Sample image not found in input/brighten.png"
